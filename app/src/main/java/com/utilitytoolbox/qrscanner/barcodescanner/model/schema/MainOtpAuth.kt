...
import com.utilitytoolbox.qrscanner.barcodescanner.utils.appendQueryParameterIfNotNullOrBlank
import java.io.Serializable

data class OtpAuthModel(
    ...
    companion object {
        ...
        fun parse(text: String): OtpAuthModel? {
            ...
            return OtpAuthModel(type, label, issuer, secret, algorithm, digits, period, counter)
        }
    }
