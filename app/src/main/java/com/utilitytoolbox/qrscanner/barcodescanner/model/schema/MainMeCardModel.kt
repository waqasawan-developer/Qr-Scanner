...
import com.utilitytoolbox.qrscanner.barcodescanner.utils.formatOrNull
import com.utilitytoolbox.qrscanner.barcodescanner.utils.joinToStringNotNullOrBlankWithLineSeparator
import com.utilitytoolbox.qrscanner.barcodescanner.utils.parseOrNull
import com.utilitytoolbox.qrscanner.barcodescanner.utils.removePrefixIgnoreCase
import com.utilitytoolbox.qrscanner.barcodescanner.utils.removeStartAll
...
data class MeCardModel(
    ...
    companion object {
        ...
        fun parse(text: String): MeCardModel? {
            ...
            return MeCardModel(firstName, lastName, nickname, phone, email, birthday, note, address)
        }
    }
