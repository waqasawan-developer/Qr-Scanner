...
import com.utilitytoolbox.qrscanner.barcodescanner.utils.equalsAnyIgnoreCase
...
class CryptocurrencyModel(
    ...
    companion object {
        ...
        fun parse(text: String): CryptocurrencyModel? {
            ...
            return CryptocurrencyModel(cryptocurrency, address, label, amount, message)
        }
    }
